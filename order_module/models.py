...
class Order_Model(models.Model):
    User = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name='صاحب سبد خرید')
...
class Order_detail(models.Model):
    ...
    final_price = models.IntegerField(null=True, blank=True, verbose_name='قیمت نهایی  تکی محثول')
