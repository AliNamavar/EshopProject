...
class siteSettings(models.Model):
    ...
    phone_number = models.CharField(
        max_length=100, null=True, blank=True, verbose_name="شماره ی سایت"
    )
    fax_number = models.CharField(
        max_length=100, null=True, blank=True, verbose_name="فکس سایت"
    )
    email = models.CharField(
        max_length=100, null=True, blank=True, verbose_name="ایمیل سایت"
    )
    ...
    work_hours = models.CharField(
        max_length=100, null=True, blank=True, verbose_name="ساعات کاری"
    )
...
class footerLink(models.Model):
    ...
    footer_link_box = models.ForeignKey(
        footerLinkBox, on_delete=models.CASCADE, verbose_name="دسته بندی"
    )
...
class site_banner(models.Model):
    ...
    url_title = models.URLField(
        max_length=400, verbose_name="عنوان بنر در url", null=True, blank=True
    )
    ...
    position = models.CharField(
        ...
        choices=site_banner_position.choices,
    )
